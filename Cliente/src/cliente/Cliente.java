...
public class Cliente {
    ...
    public void iniciar() {
        try {
            Socket yo = new Socket("127.0.0.1", 5432);
            ...
            if (respuesta == true) {
                ...
                destino = new FileOutputStream("C:\\Users\\USUARIO\\Desktop\\SD\\Practica 1\\Cliente\\destino\\" + nombreArchivo);
    ...
    public void iniciar1() {
        try {
            Socket yo = new Socket("127.0.0.1", 5434);
    ...
    public void abrir_archivo() {
        ...
        try {
            ...
            while(true){
                ...
                Servidor1.Tarea.escribir("Socket escuchando en puerto 5433");
                s = ss.accept();
                id++;
